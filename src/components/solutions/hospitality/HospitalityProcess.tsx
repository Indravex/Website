...
import { hospitalityProcess } from "../../../data/hospitality";
import styles from "../Healthcare.module.css";

export default function HospitalityProcess() {
  return (
    <section className={`${styles.section} ${styles.journey}`}>
      <div className={styles.container}>
        <div className={styles.centerHeading}>
          <div className={styles.eyebrow}>Implementation Roadmap</div>
        </div>
        ...
        <p className="font-sans text-[14px] text-[#5C5C5C] leading-[1.6] max-w-[580px] mx-auto text-center mt-3 font-medium">
          A seamless deployment methodology designed to upgrade hotel networks, PMS software, and keyless access without disrupting guest stays.
        </p>
