...
import { hospitalityServices } from "../../../data/hospitality";
  ...
  return (
    <section className={`${styles.section} ${styles.offer}`}>
      <div className={`${styles.container} ${styles.offerGrid}`}>
        ...
        <div>
          <div className={styles.eyebrow}>Elevating Hotel Technology</div>
          <h2 className={styles.sectionTitle}>Built For Modern Hospitality</h2>
          <p className={styles.sectionCopy}>
            From boutique hotels to global resort chains, we deliver integrated IT solutions that enhance guest satisfaction and streamline hotel operations.
          </p>
        </div>
        ...
        <svg style={{ width: 0, height: 0, position: 'absolute', pointerEvents: 'none' }}>
          <defs>
            <linearGradient id="hosp-border-beam" x1="0%" y1="0%" x2="100%" y2="100%">
