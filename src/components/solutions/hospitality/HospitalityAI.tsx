...
import { hospitalityChecklist, hospitalityStats } from "../../../data/hospitality";
import styles from "../Healthcare.module.css";

export default function HospitalityAI() {
    ...
    <section className={`${styles.section} ${styles.thoughtful}`}>
      <div className={`${styles.container} ${styles.thoughtfulGrid}`}>
        ...
        <div className={styles.visualPanel}>
          <div className={styles.maroonPanel}>
            <div className={styles.panelText}>
              ...
              <p>Our hospitality tech platform connects PMS, smart room IoT, keyless access, and staff operations into a high-concurrency cloud system.</p>
              
              <ul className={styles.checklistList}>
                {hospitalityChecklist.map((item, index) => (
                  <motion.li 
                    key={index}
          ...
          <div className={styles.thoughtfulImage}>
            <div className="w-full h-full relative min-h-[380px] bg-gradient-to-br from-[#EEF2F6] to-[#FAF9F6] flex items-center justify-center border border-[#E2EAF8]">
              <span className="text-[#004BFF] font-serif italic text-lg opacity-45">Guest Portal & Network Telemetry View</span>
            </div>
          </div>
        ...
        <div className={styles.approach}>
          ...
          <h2 className={styles.sectionTitle}>Engineered For Guest Delight</h2>
