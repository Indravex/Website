...
import { aboutPillars } from "../../../data/aboutUs";
  ...
  return (
    <section className={`${styles.section} ${styles.offer}`}>
      <div className={`${styles.container} ${styles.offerGrid}`}>
        ...
        <div>
          <div className={styles.eyebrow}>Our Engineering Standards</div>
          <h2 className={styles.sectionTitle}>Built On Core Principles</h2>
          <p className={styles.sectionCopy}>
            We combine rigorous architectural standards with user-centered design to ensure every digital product we ship creates long-term enterprise value.
          </p>
        </div>
        ...
        <svg style={{ width: 0, height: 0, position: 'absolute', pointerEvents: 'none' }}>
          <defs>
            <linearGradient id="about-border-beam" x1="0%" y1="0%" x2="100%" y2="100%">
